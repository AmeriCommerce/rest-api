...
Applies a coupon/discount code to this cart and recalculates the total based on that code. Returns a `200 OK` response with the [cart resource](/acapi.yaml/paths/~1carts/get) as the response body.
